...
public class SinglyLinkedList<T> implements Iterable<T>
{
	...
	*/
	...
	public void multiUnzip( int k )
	{
		...
		List<Entry<T>> heads = IntStream.range( 0, k ).mapToObj( i -> new Entry<T>( null, null ) )
	...
	public void printReverse()
	{
		...
		// Loop invariant -
		//  cursor - Pointer to current element in the list
		while( cursor != null )
		{
	...
	public static void main( String[] args ) throws NoSuchElementException
	{
		...
		System.out.print("Original list: "); lst.printList();

		Scanner in = new Scanner( System.in );

		lst.printList();
		System.out.print("Enter k for MultiUnzip: ");
		lst.multiUnzip( in.nextInt() );
		lst.printList();

		System.out.print("Print recursive reverse: "); lst.printReverseRecursive();
		System.out.print("Print iterative reverse: "); lst.printReverse();

		lst.iterativeReverse();
		System.out.print("List iterative reverse: "); lst.printList();

		lst.recursiveReverse();
		System.out.print("List recursive reverse: "); lst.printList();
	}
}